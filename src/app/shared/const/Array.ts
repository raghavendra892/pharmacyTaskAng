...
export let ordersConst: Array<IOrders> = [
    {
      id: '714-69-5617',
  ...
  export let productsConst: Array<IProducts> = [
    {
      id: '56104-020',
  ...
  export let usersConst: Array<IUsers> = [
    {
      id: 1,
    ...
    },
    {
      id: 2,
      profilePic:
        'https://robohash.org/quosquiatenetur.bmp?size=50x50&set=set1',
    ...
    },
    {
      id: 9,
      profilePic:
        'https://robohash.org/ipsummodiminima.jpg?size=50x50&set=set1',
    ...
    },
    {
      id: 11,
      profilePic:
        'https://robohash.org/estmagnitempore.jpg?size=50x50&set=set1',
    ...
    },
    {
      id: 22,
      profilePic:
        'https://robohash.org/utaperiamfacilis.bmp?size=50x50&set=set1',
